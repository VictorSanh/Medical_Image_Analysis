...
void zachPrimalDual(float *theta, float *g, float *dataEnergy, float lambda, int nRegions, int width, int height, int maxSteps, int outStep = 100, bool debugInfo = true);
void chambollePrimalDual(float *theta, float *g, float *dataEnergy, float lambda, int nRegions, int width, int height, int maxSteps, int outStep = 100, bool debugInfo = true);
